...
2.1. реализован доступ отношению валюты к рублю <rate_key> по адресу 'http://127.0.0.1:5000/<rate_key>'
2.2. реализован JSON-log обработчик ошибки 404 в случае запроса 'http://127.0.0.1:5000/<wrong_way>'

# В разработке
Реализация формата from to по адресу 'http://127.0.0.1:5000/<from>/<to>'
вызов и обработка исключений flask
